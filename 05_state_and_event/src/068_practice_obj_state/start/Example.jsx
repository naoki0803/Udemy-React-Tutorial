...
const Example = () => {
  ...
  // setOrderを非同期で定義している。
  // 第一引数の新しいObjectは、orderObj(初期値)ではなく、状態監視されているorderを渡す必要がある
  const changeItem = (e) => {
  ...
  return (
    <div>
      <h3>練習問題</h3>
      <p>
        記述を変更し、完成コードのように「+と-ボタンをクリックするとCountの表示が1ずつ増減する機能」と
        「input要素に連動してItemの表示が変更される機能」を実装してください。コンポーネントの外側（上部）に変数や関数を準備しているためうまく使ってください。
      </p>
